...
#define __ctype_ptr (char*)stdc_D97B0687
#define _Stdin (stdc_32E56B1A)
#define _Stdout (stdc_FB2BD688)
#define _Stderr (stdc_FEFBE065)
...
extern double stdc_742F12B4(double x, unsigned int y);
...
extern const char *stdc_DEBEE2AF(const char *str, int c);                                         // strchr()
